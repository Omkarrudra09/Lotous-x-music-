...
from LotousXMusic import YouTube, app
from LotousXMusic.core.call import Hotty
from LotousXMusic.misc import SUDOERS, db
...
from LotousXMusic.utils.formatters import seconds_to_min
from LotousXMusic.utils.inline import close_markup, stream_markup, stream_markup_timer
from LotousXMusic.utils.stream.autoclear import auto_clean
from LotousXMusic.utils.thumbnails import get_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
...
@app.on_callback_query(filters.regex("ADMIN") & ~LOTOUS_USERS)
@languageCB
