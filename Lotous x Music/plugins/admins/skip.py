...
from LotousXMusic.utils.database import get_loop
from LotousXMusic.utils.decorators import AdminRightsCheck
from LotousXMusic.utils.inline import close_markup, stream_markup
...
@app.on_message(
    filters.command(["skip", "cskip", "next", "cnext"]) & filters.group & ~LOTOUS_USERS
)
@AdminRightsCheck
