...
from LotousXMusic.utils import extract_user, int_to_alpha
...
from LotousXMusic.utils.decorators import AdminActual, language
from LotousXMusic.utils.inline import close_markup
from config import BANNED_USERS, adminlist


@app.on_message(filters.command("auth") & filters.group & ~LOTOUS_USERS)
@AdminActual
...
@app.on_message(filters.command("unauth") & filters.group & ~LOTOUS_USERS)
@AdminActual
...
@app.on_message(
    filters.command(["authlist", "authusers"]) & filters.group & ~LOTOUS_USERS
)
@language
