...
from LotousXMusic.utils.database import (
    add_nonadmin_chat,
    get_authuser,
    get_authuser_names,
    get_playmode,
...
from LotousXMusic.utils.decorators.admins import ActualAdminCB
from LotousXMusic.utils.decorators.language import language, languageCB
from LotousXMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from LotousXMusic.utils.inline.start import private_panel
from config import LOTOUS_USERS, OWNER_ID, MUSIC_BOT_NAME, START_IMG_URL


@app.on_message(
    filters.command(["settings", "setting"]) & filters.group & ~LOTOUS_USERS
)
@language
...
@app.on_callback_query(filters.regex("gib_source") & ~LOTOUS_USERS)
@languageCB
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaVideo("https://te.legra.ph/file/13d410c5ae225e7ff5ec8.mp4"),
...
@app.on_callback_query(
    filters.regex("settings_helper") & ~LOTOUS_USERS
)
@languageCB
...
@app.on_callback_query(filters.regex("settingsback_helper") & ~LOTOUS_USERS)
@languageCB
...
@app.on_callback_query(filters.regex("FERRARIUDTI") & ~LOTOUS_USERS)
@ActualAdminCB
...
@app.on_callback_query(filters.regex(pattern=r"^(AUTH|AUTHLIST)$") & ~LOTOUS_USERS)
@ActualAdminCB
...
@app.on_callback_query(filters.regex("VOMODECHANGE") & ~LOTOUS_USERS)
@ActualAdminCB
