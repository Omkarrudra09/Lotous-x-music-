...
from LotousXMusic.utils.formatters import convert_bytes
from LotousXMusic.utils.inline.song import song_markup
...
@app.on_callback_query(filters.regex(pattern=r"song_back") & ~LOTOUS_USERS)
@languageCB
...
@app.on_callback_query(filters.regex(pattern=r"song_helper") & ~LOTOUS_USERS)
@languageCB
...
@app.on_callback_query(
    filters.regex(pattern=r"song_download") & ~LOTOUS_USERS
)
@languageCB
