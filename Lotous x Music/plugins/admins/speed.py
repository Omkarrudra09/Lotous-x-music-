...
from LotousXMusic.utils import AdminRightsCheck
from LotousXMusic.utils.database import is_active_chat, is_nonadmin_chat
from LotousXMusic.utils.decorators.language import languageCB
from LotousXMusic.utils.inline import close_markup, speed_markup
from config import LOTOUS_USERS, adminlist
...
@app.on_callback_query(filters.regex("SpeedUP") & ~LOTOUS_USERS)
@languageCB
