...
from LotousXMusic.utils.database import set_cmode
from LotousXMusic.utils.decorators.admins import AdminActual
from config import LOTOUS_USERS


@app.on_message(filters.command(["channelplay"]) & filters.group & ~LOTOUS_USERS)
@AdminActual
